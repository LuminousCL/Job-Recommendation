...
public class MonkeyLearnClient {
	private static final String API_KEY = "fec5a0efa48a276147f2efedb92e9239d16aa66f";// make sure change it to your api key.
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		try {
			response = ml.extractors.extract("ex_YCya9nrn", text, 
					extraParams);//change to your model id
